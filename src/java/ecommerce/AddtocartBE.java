 ...
 * @author Jayan
 */
@WebServlet(name = "AddtocartBE", urlPatterns = {"/AddtocartBE"})
public class AddtocartBE extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           out.println("<!DOCTYPE html>");
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AddtocartBE</title>");
            out.println("</head>");
            out.println("<body>");
...
//out.println("<h1>Servlet AddAttdBE at " + request.getContextPath() + "</h1>");
            ...
            String sql = "insert into CART(PNAME,CATEGORY,PPRICE,QUANTITY) values(?,?,?,?)";
        ...
        out.println("<script>");
        out.println("    var confirmation = confirm('Item Added To Cart');");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(AddtocartBE.class.getName()).log(Level.SEVERE, null, ex);
